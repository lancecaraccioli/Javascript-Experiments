/*!
 * jQuery Gesture Plugin
 * Examples at: http://jqsandbox.mrburly.com:8888
 * Copyright (c) 2009 Lance Caraccioli
 * Version: 0.01 (4-APR-2009)
 * Dual licensed under the MIT and GPL licenses.
 * http://docs.jquery.com/License
 *
 * Originally based on the work of: Adrien Friggeri (http://random.friggeri.net/jquery-gestures/)
 */
(function($) {
	...
	$.fn.gesture = function(settings){
		...
		var me = $(this);
		me.find('img').mousedown(function(event){
			event.preventDefault();//stop images from being drug around by some browsers
		});
